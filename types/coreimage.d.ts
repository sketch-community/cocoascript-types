...
declare namespace cocoascript {
  ...
  interface CIImage extends NSObject {
    ...
    imageWithTexture_size_flipped_colorSpace(name: number, size: CGSize, flipped: boolean, colorSpace: CGColorSpaceRef):CIImage;
    // https://developer.apple.com/documentation/coreimage/ciimage/1547000-imagewithtexture
    imageWithTexture_size_flipped_options(name: number, size: CGSize, flipped: boolean, options: CIImage):CIImage;
    ...
    initWithTexture_size_flipped_colorSpace(name: number, size: CGSize, flipped: boolean, colorSpace: CGColorSpaceRef):CIImage;
    // https://developer.apple.com/documentation/coreimage/ciimage/1437880-initwithtexture
    initWithTexture_size_flipped_options(name: number, size: CGSize, flipped: boolean, options: CIImage):CIImage;
...
declare namespace cocoascript {
  ...
  interface CIFilterShape extends NSObject {
    ...
    transformBy_interior(m: CGAffineTransform, flag: boolean):CIFilterShape;
...
declare namespace cocoascript {
  ...
  interface CIQRCodeFeature extends CIFeature {
    ...
    setMessageString(value: string | cocoascript.NSString): void;
...
declare namespace cocoascript {
  ...
  interface CIFilterGenerator extends NSObject {
    ...
    setExportedKeys(value: NSDictionary): void;
    ...
    setClassAttributes(value: NSDictionary): void;
    // https://developer.apple.com/documentation/coreimage/cifiltergenerator/1438179-writetourl
    writeToURL_atomically(aURL: NSURL, flag: boolean):boolean;
...
declare namespace cocoascript {
  ...
  interface CIContext extends NSObject {
    ...
    createCGImage_fromRect_format_colorSpace_deferred(image: CIImage, fromRect: CGRect, format: CIFormat, colorSpace: CGColorSpaceRef, deferred: boolean):CGImageRef;
    ...
    writeTIFFRepresentationOfImage_toURL_format_colorSpace_options_error(image: CIImage, url: NSURL, format: CIFormat, colorSpace: CGColorSpaceRef, options: CIContext, errorPtr: NSError):boolean;
    // https://developer.apple.com/documentation/coreimage/cicontext/1642218-writejpegrepresentationofimage
    writeJPEGRepresentationOfImage_toURL_colorSpace_options_error(image: CIImage, url: NSURL, colorSpace: CGColorSpaceRef, options: CIContext, errorPtr: NSError):boolean;
    // https://developer.apple.com/documentation/coreimage/cicontext/2866197-writepngrepresentationofimage
    writePNGRepresentationOfImage_toURL_format_colorSpace_options_error(image: CIImage, url: NSURL, format: CIFormat, colorSpace: CGColorSpaceRef, options: CIContext, errorPtr: NSError):boolean;
    // https://developer.apple.com/documentation/coreimage/cicontext/2902266-writeheifrepresentationofimage
    writeHEIFRepresentationOfImage_toURL_format_colorSpace_options_error(image: CIImage, url: NSURL, format: CIFormat, colorSpace: CGColorSpaceRef, options: CIContext, errorPtr: NSError):boolean;
    // https://developer.apple.com/documentation/coreimage/cicontext/2875428-preparerender
    prepareRender_fromRect_toDestination_atPoint_error(image: CIImage, fromRect: CGRect, destination: CIRenderDestination, atPoint: CGPoint, error: NSError):boolean;
    ...
    // https://developer.apple.com/documentation/coreimage/cicontext/3762899-heif10representationofimage
    HEIF10RepresentationOfImage_colorSpace_options_error(image: CIImage, colorSpace: CGColorSpaceRef, options: CIContext, errorPtr: NSError):NSData;
    // https://developer.apple.com/documentation/coreimage/cicontext/3762900-writeheif10representationofimage
    writeHEIF10RepresentationOfImage_toURL_colorSpace_options_error(image: CIImage, url: NSURL, colorSpace: CGColorSpaceRef, options: CIContext, errorPtr: NSError):boolean;
    //
    alloc():CIContext;
    //
    init():CIContext;
...
declare namespace cocoascript {
  ...
  interface CIKernel extends NSObject {
    ...
    // https://developer.apple.com/documentation/coreimage/cikernel/3857565-kernelswithmetalstring
    kernelsWithMetalString_error(source: string | cocoascript.NSString, error: NSError):CIKernel;
    //
    alloc():CIKernel;
    //
    init():CIKernel;
...
declare namespace cocoascript {
  ...
  interface CITextFeature extends CIFeature {
    ...
    subFeatures(): NSArray;
    setSubFeatures(value: NSArray): void;
...
declare namespace cocoascript {
  ...
  interface CIQRCodeDescriptor extends CIBarcodeDescriptor {
    ...
    setErrorCorrectionLevel(value: CIQRCodeErrorCorrectionLevel): void;
    //
...
declare namespace cocoascript {
  ...
  interface CIAztecCodeDescriptor extends CIBarcodeDescriptor {
    ...
    initWithPayload_isCompact_layerCount_dataCodewordCount(errorCorrectedPayload: NSData, isCompact: boolean, layerCount: NSInteger, dataCodewordCount: NSInteger):CIAztecCodeDescriptor;
    // https://developer.apple.com/documentation/coreimage/ciazteccodedescriptor/2875192-descriptorwithpayload
    descriptorWithPayload_isCompact_layerCount_dataCodewordCount(errorCorrectedPayload: NSData, isCompact: boolean, layerCount: NSInteger, dataCodewordCount: NSInteger):CIAztecCodeDescriptor;
    ...
    setLayerCount(value: NSInteger): void;
    ...
    setDataCodewordCount(value: NSInteger): void;
    //
...
declare namespace cocoascript {
  ...
  interface CIPDF417CodeDescriptor extends CIBarcodeDescriptor {
    ...
    initWithPayload_isCompact_rowCount_columnCount(errorCorrectedPayload: NSData, isCompact: boolean, rowCount: NSInteger, columnCount: NSInteger):CIPDF417CodeDescriptor;
    // https://developer.apple.com/documentation/coreimage/cipdf417codedescriptor/2875195-descriptorwithpayload
    descriptorWithPayload_isCompact_rowCount_columnCount(errorCorrectedPayload: NSData, isCompact: boolean, rowCount: NSInteger, columnCount: NSInteger):CIPDF417CodeDescriptor;
...
declare namespace cocoascript {
  ...
  interface CIDataMatrixCodeDescriptor extends CIBarcodeDescriptor {
    ...
    setEccVersion(value: CIDataMatrixCodeECCVersion): void;
    //
...
declare namespace cocoascript {
  ...
  interface CIPlugIn extends NSObject {
    ...
    loadPlugIn_allowExecutableCode(url: NSURL, allowExecutableCode: boolean):void;
    // https://developer.apple.com/documentation/coreimage/ciplugin/1551323-loadplugin
    loadPlugIn_allowNonExecutable(url: NSURL, allowNonExecutable: boolean):void;
...
declare namespace cocoascript {
  ...
  interface CIRenderDestination extends NSObject {
    ...
    setBlendsInDestinationColorSpace(value: boolean): void;
...
declare namespace cocoascript {
  ...
  interface CIImageProcessorKernel extends NSObject {
    ...
    setSynchronizeInputs(value: boolean): void;
    ...
    processWithInputs_arguments_output_error(inputs: CIImageProcessorInput, arguments: CIImageProcessorKernel, output: CIImageProcessorOutput, error: NSError):boolean;
...
declare namespace cocoascript {
  ...
  interface CIImageProcessorOutput {
    ...
    setMetalCommandBuffer(value: any): void;
...
declare namespace cocoascript {
   ...
   */
  interface CIRAWFilter extends CIFilter {
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801628-filterwithcvpixelbuffer
    filterWithCVPixelBuffer_properties(buffer: CVPixelBufferRef, properties: NSDictionary):CIRAWFilter;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801629-filterwithimagedata
    filterWithImageData_identifierHint(data: NSData, identifierHint: string | cocoascript.NSString):CIRAWFilter;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801630-filterwithimageurl
    filterWithImageURL(url: NSURL):CIRAWFilter;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801615-baselineexposure
    baselineExposure(): number;
    setBaselineExposure(value: number): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801616-boostamount
    boostAmount(): number;
    setBoostAmount(value: number): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801617-boostshadowamount
    boostShadowAmount(): number;
    setBoostShadowAmount(value: number): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801618-colornoisereductionamount
    colorNoiseReductionAmount(): number;
    setColorNoiseReductionAmount(value: number): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801620-contrastamount
    contrastAmount(): number;
    setContrastAmount(value: number): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801622-decoderversion
    decoderVersion(): CIRAWDecoderVersion;
    setDecoderVersion(value: CIRAWDecoderVersion): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801623-detailamount
    detailAmount(): number;
    setDetailAmount(value: number): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801626-exposure
    exposure(): number;
    ...
    setExtendedDynamicRangeAmount(value: number): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801619-colornoisereductionsupported
    colorNoiseReductionSupported(): boolean;
    setColorNoiseReductionSupported(value: boolean): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801621-contrastsupported
    contrastSupported(): boolean;
    setContrastSupported(value: boolean): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801624-detailsupported
    detailSupported(): boolean;
    setDetailSupported(value: boolean): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801625-draftmodeenabled
    draftModeEnabled(): boolean;
    setDraftModeEnabled(value: boolean): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801631-gamutmappingenabled
    gamutMappingEnabled(): boolean;
    setGamutMappingEnabled(value: boolean): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801632-lenscorrectionenabled
    lensCorrectionEnabled(): boolean;
    setLensCorrectionEnabled(value: boolean): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801633-lenscorrectionsupported
    lensCorrectionSupported(): boolean;
    setLensCorrectionSupported(value: boolean): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801636-localtonemapsupported
    localToneMapSupported(): boolean;
    setLocalToneMapSupported(value: boolean): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801638-luminancenoisereductionsupported
    luminanceNoiseReductionSupported(): boolean;
    setLuminanceNoiseReductionSupported(value: boolean): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801640-moirereductionsupported
    moireReductionSupported(): boolean;
    setMoireReductionSupported(value: boolean): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801658-sharpnesssupported
    sharpnessSupported(): boolean;
    setSharpnessSupported(value: boolean): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801634-linearspacefilter
    linearSpaceFilter(): CIFilter;
    setLinearSpaceFilter(value: CIFilter): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801635-localtonemapamount
    localToneMapAmount(): number;
    setLocalToneMapAmount(value: number): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801637-luminancenoisereductionamount
    luminanceNoiseReductionAmount(): number;
    setLuminanceNoiseReductionAmount(value: number): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801639-moirereductionamount
    moireReductionAmount(): number;
    setMoireReductionAmount(value: number): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801641-nativesize
    nativeSize(): CGSize;
    setNativeSize(value: CGSize): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801642-neutralchromaticity
    neutralChromaticity(): CGPoint;
    setNeutralChromaticity(value: CGPoint): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801643-neutrallocation
    neutralLocation(): CGPoint;
    setNeutralLocation(value: CGPoint): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801644-neutraltemperature
    neutralTemperature(): number;
    setNeutralTemperature(value: number): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801645-neutraltint
    neutralTint(): number;
    setNeutralTint(value: number): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801646-orientation
    orientation(): CGImagePropertyOrientation;
    setOrientation(value: CGImagePropertyOrientation): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801647-portraiteffectsmatte
    portraitEffectsMatte(): CIImage;
    setPortraitEffectsMatte(value: CIImage): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801648-previewimage
    previewImage(): CIImage;
    setPreviewImage(value: CIImage): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801649-properties
    properties(): NSDictionary;
    setProperties(value: NSDictionary): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801650-scalefactor
    scaleFactor(): number;
    setScaleFactor(value: number): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801651-semanticsegmentationglassesmatte
    semanticSegmentationGlassesMatte(): CIImage;
    setSemanticSegmentationGlassesMatte(value: CIImage): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801652-semanticsegmentationhairmatte
    semanticSegmentationHairMatte(): CIImage;
    setSemanticSegmentationHairMatte(value: CIImage): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801653-semanticsegmentationskinmatte
    semanticSegmentationSkinMatte(): CIImage;
    setSemanticSegmentationSkinMatte(value: CIImage): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801654-semanticsegmentationskymatte
    semanticSegmentationSkyMatte(): CIImage;
    setSemanticSegmentationSkyMatte(value: CIImage): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801655-semanticsegmentationteethmatte
    semanticSegmentationTeethMatte(): CIImage;
    setSemanticSegmentationTeethMatte(value: CIImage): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801656-shadowbias
    shadowBias(): number;
    setShadowBias(value: number): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801657-sharpnessamount
    sharpnessAmount(): number;
    setSharpnessAmount(value: number): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801660-supporteddecoderversions
    supportedDecoderVersions(): CIRAWDecoderVersion;
    setSupportedDecoderVersions(value: CIRAWDecoderVersion): void;
    // https://developer.apple.com/documentation/coreimage/cirawfilter/3801659-supportedcameramodels
    supportedCameraModels(): string | cocoascript.NSString;
    setSupportedCameraModels(value: string | cocoascript.NSString): void;
    //
    alloc():CIRAWFilter;
    //
    init():CIRAWFilter;
...
declare const CIRAWFilter: cocoascript.CIRAWFilter;
declare namespace cocoascript {
  /**
...
declare namespace cocoascript {
  ...
  interface CIAreaReductionFilter extends CIFilter {
    ...
    inputImage(): CIImage;
    setInputImage(value: CIImage): void;
  }
}
declare namespace cocoascript {
  /**
...
declare namespace cocoascript {
  ...
  interface CIColorAbsoluteDifference extends CIFilter {
    ...
    inputImage2(): CIImage;
    setInputImage2(value: CIImage): void;
  }
}
declare namespace cocoascript {
  /**
...
declare namespace cocoascript {
  ...
  interface CIDisplacementDistortion extends CIFilter {
    ...
    setDisplacementImage(value: CIImage): void;
...
declare namespace cocoascript {
  ...
  interface CIGlassDistortion extends CIFilter {
    ...
    setTextureImage(value: CIImage): void;
  }
}
declare namespace cocoascript {
  /**
...
declare namespace cocoascript {
  ...
  interface CIKMeans extends CIAreaReductionFilter {
    ...
    inputMeans(): CIImage;
    setInputMeans(value: CIImage): void;
...
declare namespace cocoascript {
  ...
  interface CINinePartTiled extends CIFilter {
    ...
    flipYTiles(): boolean;
    setFlipYTiles(value: boolean): void;
...
declare namespace cocoascript {
  /**
   * https://developer.apple.com/documentation/coreimage/cipersonsegmentation
   */
  interface CIPersonSegmentation extends CIFilter {
    // https://developer.apple.com/documentation/coreimage/cipersonsegmentation/3750392-inputimage
    inputImage(): CIImage;
    setInputImage(value: CIImage): void;
    // https://developer.apple.com/documentation/coreimage/cipersonsegmentation/3784637-qualitylevel
    qualityLevel(): NSUInteger;
    setQualityLevel(value: NSUInteger): void;
  }
}
declare namespace cocoascript {
  /**
...
declare namespace cocoascript {
  ...
  interface CICMYKHalftone extends CIFilter {
    ...
    setGrayComponentReplacement(value: number): void;
    ...
    setUnderColorRemoval(value: number): void;
...
declare namespace cocoascript {
  ...
  interface CIPDF417BarcodeGenerator extends CIFilter {
    ...
    setPreferredAspectRatio(value: number): void;
...
declare namespace cocoascript {
  ...
  interface CIQRCodeGenerator extends CIFilter {
    ...
    setCorrectionLevel(value: string | cocoascript.NSString): void;
...
declare namespace cocoascript {
  ...
  interface CICompositeOperation extends CIFilter {
    ...
    setBackgroundImage(value: CIImage): void;
...
declare namespace cocoascript {
  ...
  interface CIAttributedTextImageGenerator extends CIFilter {
    ...
    setText(value: NSAttributedString): void;
  }
}
declare namespace cocoascript {
  /**
...
declare namespace cocoascript {
  ...
  interface CIBarcodeGenerator extends CIFilter {
    ...
    setBarcodeDescriptor(value: CIBarcodeDescriptor): void;
  }
}
declare namespace cocoascript {
  /**
  ...
  interface CIBarsSwipeTransition extends CITransitionFilter {
    ...
    barOffset(): number;
    setBarOffset(value: number): void;
...
declare namespace cocoascript {
  ...
  interface CIBlendWithMask extends CIFilter {
    ...
    maskImage(): CIImage;
    setMaskImage(value: CIImage): void;
  }
}
declare namespace cocoascript {
  /**
...
declare namespace cocoascript {
  ...
  interface CICode128BarcodeGenerator extends CIFilter {
    ...
    setBarcodeHeight(value: number): void;
    ...
    quietSpace(): number;
    setQuietSpace(value: number): void;
  }
}
declare namespace cocoascript {
  /**
...
declare namespace cocoascript {
  ...
  interface CIColorCrossPolynomial extends CIFilter {
    ...
    setBlueCoefficients(value: CIVector): void;
    ...
    setGreenCoefficients(value: CIVector): void;
    ...
    setRedCoefficients(value: CIVector): void;
  }
}
declare namespace cocoascript {
  /**
...
declare namespace cocoascript {
  ...
  interface CIColorMap extends CIFilter {
    ...
    setGradientImage(value: CIImage): void;
...
declare namespace cocoascript {
  ...
  interface CIColorPolynomial extends CIFilter {
    ...
    setAlphaCoefficients(value: CIVector): void;
...
declare namespace cocoascript {
  ...
  interface CIConvolution extends CIFilter {
    ...
    weights(): CIVector;
    setWeights(value: CIVector): void;
  }
}
declare namespace cocoascript {
  /**
...
declare namespace cocoascript {
  ...
  interface CICoreMLModel extends CIFilter {
    ...
    headIndex(): number;
    setHeadIndex(value: number): void;
...
declare namespace cocoascript {
  ...
  interface CIFourfoldReflectedTile extends CIFilter {
    ...
    acuteAngle(): number;
    setAcuteAngle(value: number): void;
...
declare namespace cocoascript {
  ...
  interface CIHighlightShadowAdjust extends CIFilter {
    ...
    setHighlightAmount(value: number): void;
    ...
    shadowAmount(): number;
    setShadowAmount(value: number): void;
  }
}
declare namespace cocoascript {
  /**
...
declare namespace cocoascript {
  ...
  interface CILineOverlay extends CIFilter {
    ...
    setEdgeIntensity(value: number): void;
...
declare namespace cocoascript {
  ...
  interface CIPageCurlTransition extends CITransitionFilter {
    ...
    setBacksideImage(value: CIImage): void;
    ...
    setShadingImage(value: CIImage): void;
  }
}
declare namespace cocoascript {
  /**
  ...
  interface CIPageCurlWithShadowTransition extends CITransitionFilter {
    ...
    shadowExtent(): CGRect;
    setShadowExtent(value: CGRect): void;
...
declare namespace cocoascript {
  ...
  interface CIPaletteCentroid extends CIFilter {
    ...
    setPaletteImage(value: CIImage): void;
...
declare namespace cocoascript {
  ...
  interface CISunbeamsGenerator extends CIFilter {
    ...
    sunRadius(): number;
    setSunRadius(value: number): void;
...
// https://developer.apple.com/documentation/coreimage/kciinputenableedrmodekey
declare const kCIInputEnableEDRModeKey: cocoascript.CIRAWFilterOption;
...
// https://developer.apple.com/documentation/coreimage/kcipropertieskey
declare const kCIPropertiesKey: cocoascript.CIRAWFilterOption;
declare namespace cocoascript {
...
declare namespace cocoascript {
  // https://developer.apple.com/documentation/coreimage/cirawdecoderversion
  type CIRAWDecoderVersion = cocoascript.NSString;
}
declare namespace cocoascript {
  /**
  ...
  interface CITransitionFilter extends CIFilter {
    ...
    targetImage(): CIImage;
    setTargetImage(value: CIImage): void;
...
// https://developer.apple.com/documentation/coreimage/cirawdecoderversionnone
declare const CIRAWDecoderVersionNone: cocoascript.CIRAWDecoderVersion;
// https://developer.apple.com/documentation/coreimage/cirawdecoderversion6
declare const CIRAWDecoderVersion6: cocoascript.CIRAWDecoderVersion;
// https://developer.apple.com/documentation/coreimage/cirawdecoderversion6dng
declare const CIRAWDecoderVersion6DNG: cocoascript.CIRAWDecoderVersion;
// https://developer.apple.com/documentation/coreimage/cirawdecoderversion7
declare const CIRAWDecoderVersion7: cocoascript.CIRAWDecoderVersion;
// https://developer.apple.com/documentation/coreimage/cirawdecoderversion7dng
declare const CIRAWDecoderVersion7DNG: cocoascript.CIRAWDecoderVersion;
// https://developer.apple.com/documentation/coreimage/cirawdecoderversion8
declare const CIRAWDecoderVersion8: cocoascript.CIRAWDecoderVersion;
// https://developer.apple.com/documentation/coreimage/cirawdecoderversion8dng
declare const CIRAWDecoderVersion8DNG: cocoascript.CIRAWDecoderVersion;
